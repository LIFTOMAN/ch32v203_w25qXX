...
#define W25QFLASH_CS_SELECT 	GPIO_WriteBit(FLASH_CS_GPIO_Port, FLASH_CS_Pin, Bit_RESET);
#define W25QFLASH_CS_UNSELECT 	GPIO_WriteBit(FLASH_CS_GPIO_Port, FLASH_CS_Pin, Bit_SET);

#define _W25QXX_USE_FREERTOS     0

#define INIT_DEBUG               1

#define W25_READ_LMN          0x03//lmn
