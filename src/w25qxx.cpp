...
//!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
void W25qxx_Delay(uint16_t dly)
{
    for (volatile int i = 0; i < dly; i++)
        asm("nop");
}
...
uint8_t W25qxx_Spi(uint8_t Data)
{
    ...
    while (!SPI_I2S_GetFlagStatus(W25QXX_SPI, SPI_I2S_FLAG_TXE));
    W25QXX_SPI->DATAR = Data;

    while (!SPI_I2S_GetFlagStatus(W25QXX_SPI, SPI_I2S_FLAG_RXNE));
    ret = W25QXX_SPI->DATAR;

    //while (SPI_I2S_GetFlagStatus(W25QXX_SPI, SPI_I2S_FLAG_BSY));
